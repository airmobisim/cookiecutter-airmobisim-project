...
# AirMobiSim_libveins
subprocess.check_call(['git', 'subtree', 'add', '--prefix=AirMobiSim_libveins', '--message', 'Merge AirMobiSim_libveins Master', 'https://github.com/airmobisim/AirMobiSim_libveins.git', 'v0.2'])
